...
Resizable.initialise = function (parentId, initialSizes, resizerThickness) {
  //Find left window
  Resizable.resizerThickness = resizerThickness ? resizerThickness : 1
  ...
  calculateMinWidthHeight() {
    if (this.children.length > 0) {
      ...
      if (this.isSplitHorizontally) {
        ...
        if (this.children[0].minHeight > this.children[1].minHeight) this.minHeight = this.children[0].minHeight
        else this.minHeight = this.children[1].minHeight
      } else if (this.isSplitVertically) {
        this.minHeight = this.children[0].minHeight + this.children[1].minHeight
        if (this.children[0].minWidth > this.children[1].minWidth) this.minWidth = this.children[0].minWidth
